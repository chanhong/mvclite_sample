  ...
  try
  {
    switch (method)
    {
      case "put":
        ...
        //sparm = new NameValueCollection { {"param","yes"}, {"where","\""+idKey+"\"='"+id+"'"} };
      ...
      case "delete":
        ...
        id = nvValue[idKey];
        //        sparm = new NameValueCollection { {"where","\""+idKey+"\"='"+id+"'"} };
        where = String.Format("{0}='{1}'", idKey,id);
      ...
      case "post":
        ...
        string nextid = CDbOle.oleGetNextId(tname, idKey, dbinfo);
