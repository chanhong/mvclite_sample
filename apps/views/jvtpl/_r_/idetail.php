...
<table class="jvtable" id="jvDetail">
  <tbody>
    <tr class="jvtable">
        <th class="jvtable" title="add a line to JV detail" align="center">
          <a href="@addDetUrl" title="Add"><img class="icon" src="@iPath/add.png"></a>
        </th>
...
//        CMsg._pdmsg(cnt, "cnt");
        ...
        <tr class='jvtable'>
          ...
          @foreach (string s in fName)
          {
            ...
            {
              cWidth = " width=\"20px\"";
              cTitle = "title=\"Use to change ordering\"";
            }
            else if (s == "descript")
            {
